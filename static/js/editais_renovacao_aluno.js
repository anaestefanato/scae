...
function handleFormSubmission(event) {
    ...
    setTimeout(() => {
        ...
        showSuccessMessage('Renovação enviada com sucesso! Você receberá uma confirmação por e-mail.');
...
function autoSaveForm() {
    ...
    localStorage.setItem('renovacao_autosave', JSON.stringify(data));
}

// Load auto-saved data
function loadAutoSavedData() {
    const savedData = localStorage.getItem('renovacao_autosave');
    if (!savedData) return;
...
function clearAutoSavedData() {
    localStorage.removeItem('renovacao_autosave');
}
